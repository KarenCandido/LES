...
public class Fachada implements IFachada {
    ...
    public Fachada() {
        ...
        /*
         * Criando uma lista para conter as regras de negócio de livro quando a operação
         * for salvar
         */
        ...
        /*
         * Adiciona a listra de regras na operação salvar no mapa do livro (lista criada
         * na linha 114)
         */
